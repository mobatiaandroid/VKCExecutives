...
import com.mobatia.vkcexecutive.adapter.HomeBrandBannerOneAdapter;
import com.mobatia.vkcexecutive.adapter.HomeBrandBannerTwoAdapter;
import com.mobatia.vkcexecutive.adapter.HomeImageBannerAdapter;
import com.mobatia.vkcexecutive.adapter.HomeImageBannerAdapterFirst;
import com.mobatia.vkcexecutive.adapter.HomeOfferBannerAdapter;
...
public class HomeFragment extends Fragment implements VKCUrlConstants,
    ...
    private void deviceRegister() {
        ...
        String values[] = {"", AppPrefenceManager.getFCMID(getActivity())};
