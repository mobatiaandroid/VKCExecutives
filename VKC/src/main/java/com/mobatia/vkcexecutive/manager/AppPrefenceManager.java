...
public class AppPrefenceManager {
    ...
    public static String getSelectedDealerName(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
    ...
    public static void saveSelectedDealerName(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
    ...
    public static String getSelectedSubDealerDealerName(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        text = settings.getString("sel_user_sub_deal", "");
        return text;
    }

    public static void saveSelectedSubDealerDealerName(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        ...
        editor.putString("sel_user_sub_deal", text.toString());
        editor.commit();
    }

    public static String getSelectedSubDealerName(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        text = settings.getString("sel_sub_name", "");
        return text;
    }

    public static void saveSelectedSubDealerName(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        ...
        editor.putString("sel_sub_name", text.toString());
        editor.commit();
    }

    public static String getSelectedDealerId(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
    ...
    public static void saveSelectedSubDealerId(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        ...
        editor.putString("sel_sub_dealer_id", text.toString());
        editor.commit();
    }

    public static String getSelectedSubDealerId(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        text = settings.getString("sel_sub_dealer_id", "");
        return text;
    }

    public static void saveSelectedDealerId(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
    ...
    public static String getSelectedUserType(Context context) {
        SharedPreferences settings;
        String text;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        text = settings.getString("sel_user_type", "");
        return text;
    }

    public static void saveSelectedUserType(Context context, String text) {
        SharedPreferences settings;
        Editor editor;
        settings = context.getSharedPreferences(PREFS_NAME,
                Context.MODE_PRIVATE);
        ...
        editor.putString("sel_user_type", text.toString());
        editor.commit();
    }
